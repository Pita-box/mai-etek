    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white p-4">
      <div className="max-w-md w-full bg-gray-800 rounded-lg shadow-xl p-8 text-center space-y-6 border border-gray-700">
        ...
        <p className="text-gray-400">
          Your account has been created successfully, but you are currently in an unassigned state.
        </p>
        
        <div className="pt-4 border-t border-gray-700">
          <p className="text-sm text-gray-500">
            Please wait for a DOM to claim your account. Once claimed, your features will unlock automatically.
          </p>
        </div>
