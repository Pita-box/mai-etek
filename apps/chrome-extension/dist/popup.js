...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DEFAULT_POPUP_PASSWORD: () => (/* binding */ DEFAULT_POPUP_PASSWORD),
/* harmony export */   extendPopupUnlockWindow: () => (/* binding */ extendPopupUnlockWindow),
/* harmony export */   isPopupUnlocked: () => (/* binding */ isPopupUnlocked),
/* harmony export */   lockPopup: () => (/* binding */ lockPopup),
...
/* harmony import */ var _shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/popup-lock */ "./src/shared/popup-lock.ts");
...
function startUnlockedTimers() {
    ...
    lockRefreshTimerId = window.setInterval(() => {
        void (0,_shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__.extendPopupUnlockWindow)().catch(() => null);
...
async function refresh() {
    if (!isUnlocked)
        return;
    await (0,_shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__.extendPopupUnlockWindow)().catch(() => null);
...
async function unlock() {
    ...
    try {
        const unlocked = await (0,_shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__.unlockPopup)(password);
        if (!unlocked) {
...
async function heartbeat() {
    ...
    try {
        ...
        setMessage(error instanceof Error
            ? error.message
            : "Heartbeat se nepodařilo odeslat.", true);
    }
    finally {
        setBusy(false);
    }
...
async function initialize() {
    isUnlocked = await (0,_shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__.isPopupUnlocked)();
    if (!isUnlocked) {
        renderLocked();
        return;
    }
...
window.addEventListener("beforeunload", () => {
    if (isUnlocked) {
        void (0,_shared_popup_lock__WEBPACK_IMPORTED_MODULE_3__.lockPopup)().catch(() => null);
    }
});
